...
class Consult extends Config
{
    ...
    public function create()
    {
        ...
        $query = "INSERT INTO
					" . $this->table_name . "
				SET
					name = ?, phone = ?, age = ?, email = ?, address = ?, nhombenh = ?, title = ?, content = ?, date = ?, reply = ?";
    ...
    public function readOne()
    {
        ...
        if ($row['id']) {
            ...
            $this->nhombenh_id = $row['nhombenh_id'] = $row['nhombenh'];

...
JOB = {
	...
	Init : function() {
		...
		var script  = document.createElement('script');
  		script.src  = MAIN_URL+"/assets/plugins/JOB/exif.js";
	...
	DecoderWorker : new Worker(MAIN_URL+"/assets/plugins/JOB/DecoderWorker.js"),
	...
	JOBDecodeImage : function (image,orientation,sceneCaptureType) {
		if (orientation == 8 || orientation == 6) {
			if(sceneCaptureType == "Landscape" && image.width > image.height) {
				orientation = 1;
				JOB.ScanCanvas.width = 600;
				JOB.ScanCanvas.height = 900;
			} else {
				JOB.ScanCanvas.width = 900;
				JOB.ScanCanvas.height = 600;
			}
		} else {
			JOB.ScanCanvas.width = 600;
			JOB.ScanCanvas.height = 900;

...
//								url: root + (url.url || url),
						...
						/* Use div position */
						emoticon     = globalDoc.createElement('div');
						emoticon.class = '_emo';
						preLoadCache.push(emoticon);
					});
				});
	...
	// TODO: Make this tag configurable.
				...
				if (options.emoticonsCompat) {
					currentEmoticons = $wysiwygBody
						.find('._emo[data-sceditor-emoticon]');
				}
			};
	...
	// TODO: Make configurable
			...
			handleBackSpace = function (e) {
				...
				if (offset !== 0 || !(parent = currentStyledBlockNode()) || !node.nodeValue) {
					return;
				}
...
*/
							$line.append(
								$('<div />').attr({
									class: '_emo',
									'data-key': code,
									style: 'background-position:'+ emoticon.url || emoticon,
									alt: code,
									title: emoticon.tooltip || code
								}).click(function () {
									editor.insert(startSpace + $(this).attr('alt') +
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
		...
		return {
			 ...
			 * @type {String}
			 */
			emoticonsRoot: MAIN_URL+"/assets/emoticons/",
			emoticons: {
				dropdown: {
					':)': 'default/smile.png',
					':angel:': 'default/angel.png',
					':angry:': 'default/angry.png',
					'8-)': 'default/cool.png',
					':\'(': 'default/cwy.png',
					':ermm:': 'default/ermm.png',
					':D': 'default/grin.png',
					'<3': 'default/heart.png',
					':(': 'default/sad.png',
					':O': 'default/shocked.png',
					':P': 'default/tongue.png',
					';)': 'default/wink.png'
				},
				more: {
					':alien:': 'default/alien.png',
					':blink:': 'default/blink.png',
					':blush:': 'default/blush.png',
					':cheerful:': 'default/cheerful.png',
					':devil:': 'default/devil.png',
					':dizzy:': 'default/dizzy.png',
					':getlost:': 'default/getlost.png',
					':happy:': 'default/happy.png',
					':kissing:': 'default/kissing.png',
					':ninja:': 'default/ninja.png',
					':pinch:': 'default/pinch.png',
					':pouty:': 'default/pouty.png',
					':sick:': 'default/sick.png',
					':sideways:': 'default/sideways.png',
					':silly:': 'default/silly.png',
					':sleeping:': 'default/sleeping.png',
					':unsure:': 'default/unsure.png',
					':woot:': 'default/w00t.png',
					':wassat:': 'default/wassat.png'
				},
				hidden: {
					':whistling:': 'default/whistling.png',
					':love:': 'default/wub.png'
				}
			},
...
*/
			emoticon: '<div class="_emo" style="background-position:{url}" data-sceditor-emoticon="{key}" data-key="{key}" ' +
				'alt="{key}" title="{tooltip}" />',

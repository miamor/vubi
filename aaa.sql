...
--
-- Host: localhost
-- Generation Time: Sep 17, 2018 at 05:58 AM
...
(1, 'Nguyen Van Aa', 'nguyen-van-aa', 'Bác sĩ chuyên khoa', '', 'http://localhost/aaa/images/anh1.jpg'),
(2, 'Nguyen Van B', 'nguyen-van-b', 'Bác sĩ chuyên khoa', '', 'http://localhost/aaa/images/anh2.jpg'),
(3, 'Nguyen Van C', 'nguyen-van-c', 'Bác sĩ chuyên khoa', '', 'http://localhost/aaa/images/anh3.jpg'),
(4, 'Nguyen Van D', 'nguyen-van-d', 'Bác sĩ chuyên khoa', '', 'http://localhost/aaa/images/anh4.jpg');
...
(1, 'Nguyen Van A', 'http://localhost/aaa/images/khachhang.jpg', 'I\'ve been using Tommus Rhodus themes for a couple of years now - they\'re always highly polished and backed up by amazing support.'),
(2, 'Nguyen Van Ba', 'http://localhost/aaa/images/khachhang.jpg', 'I\'ve been using Tommus Rhodus themes for a couple of years now - they\'re always highly polished and backed up by amazing support.'),
(3, 'Nguyen Van C', 'http://localhost/aaa/images/khachhang.jpg', 'I\'ve been using Tommus Rhodus themes for a couple of years now - they\'re always highly polished and backed up by amazing support.');
...
(1, 'Company A', 'https://infura.io/', 'http://localhost/aaa/images/doitac.jpg'),
(2, 'Company B', 'https://infura.io/', 'http://localhost/aaa/images/doitac.jpg');
...
(1, 'Tư vấn và phân tích', 'http://localhost/aaa/images/icon1.png', 'Tư vấn và phân tích gien thế hệ mới tại các phòng xét nghiệm hiện đại của Hoa Kỳ​'),
(2, 'Quy Trình Giải Mã Gien', 'http://localhost/aaa/images/icon2.png', 'Quy Trình Giải Mã Gien tiên tiến từ các trung tâm ung thư và di truyền học uy tín của Hoa Kỳ'),
(3, 'Hỗ trợ từ các chuyên gia ung thư', 'http://localhost/aaa/images/icon3.png', 'Tư vấn và phân tích gien thế hệ mới tại các phòng xét nghiệm hiện đại của Hoa Kỳ​');
